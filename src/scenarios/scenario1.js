...
// Simulated Daily (Thursday) schedule
Clock.global.observe("mm", (mm) => {
  ...
  if (time.hh == 11 && time.mm == 0) house.people.thomas.moveTo("null");
  if (time.hh == 19 && time.mm == 25) house.people.thomas.moveTo("livingroom");
  if (time.hh == 19 && time.mm == 30) house.people.thomas.moveTo("bathroom");
  if (time.hh == 19 && time.mm == 35) house.people.thomas.moveTo("kitchen");
  if (time.hh == 19 && time.mm == 40) house.people.thomas.moveTo("bedroom");
